...
public class PostDto1 {
    ...
    @QueryProjection
    public PostDto1(Long postId, String title, String memo, String url,Long categoryId,String categoryName, boolean bookmark, String nickname, LocalDateTime createdAt) {
        this.postId = postId;
        this.title = title;
        this.memo = memo;
        this.url = url;
